...
class _WebRTCScreenState extends State<WebRTCScreen> {
  ...
  Future<void> init() async {
    ...
    await subscribeCall();
    await subscribeCallEnd();
    await subscribeReject();
    await subscribeAccept();
    await subscribeHangUp();
    await subscribeVideoTrack();
    await subscribeNotAnswer();
    await subscribePeerConnection();
  }
  ...
  Future<void> setIceServers() async {
    ...
    list.add(_buildIceServer("stun:turn.quickblox.com", "quickblox",
        "baccb97ba2d92d71e26eb9886da5f1e0"));
    list.add(_buildIceServer("turn:turn.quickblox.com:3478?transport=tcp",
        "quickblox", "baccb97ba2d92d71e26eb9886da5f1e0"));
    list.add(_buildIceServer("turn:turn.quickblox.com:3478?transport=udp",
        "quickblox", "baccb97ba2d92d71e26eb9886da5f1e0"));
    ...
    try {
      ...
      SnackBarUtils.showResult(
          _scaffoldKey, "Ice Servers were set success. Amount: $amount");
    } on PlatformException catch (e) {
      DialogUtils.showError(context, e);
    }
  }
  ...
  Future<void> getIceServers() async {
    try {
      ...
      SnackBarUtils.showResult(
          _scaffoldKey, "Ice Servers were loaded. Amount: $amount");
    } on PlatformException catch (e) {
      DialogUtils.showError(context, e);
    }
  }
